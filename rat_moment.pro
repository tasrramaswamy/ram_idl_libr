function rat_moment , ARRAY , DIMENSION , NAN=NAN , DOUBLE = DOUBLE ,$
...
;		std_dev =rat_create_arr_size(av1)
		...
		0:   begin
			...
			temp = moment(rat_finite(pad_array[*,j,k,l]),/double)
		...
		1:  begin 
			...
			for k = 0,dim1[2]-1 do begin
			for l = 0 ,dim1[2]-1 do begin
			temp = moment(rat_finite(pad_array[i,*,k,l]),/double)
		...
		2:  begin
			...
			for j = 0,dim1[1]-1 do begin
			for l = 0 ,dim1[2]-1 do begin
			temp = moment(rat_finite(pad_array[i,j,*,l]),/double)
		...
		3:  begin
			...
			for j = 0,dim1[1]-1 do begin
			for k = 0,dim1[2]-1 do begin
			temp = moment(rat_finite(pad_array[i,j,k,*]),/double)
